            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-2 email-menu">
                <div class="list-group">
                    ...
                    <a href="javascript:void(0);" class="list-group-item">
                        ...
                        <span class="badge bg-warning">{{ $contacts->where('deleted_at', false)->count() }}</span>
                    </a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-10">
                <div class="panel panel-default email-panel">
                    <div class="email-panel-heading">
                        <div class="row clearfix">
                            <div class="col-sm-5">
                                <h2>OKUNMAMIŞ ({{  $contacts->where('read_receipt', false)->count() }})</h2>
                            </div>
                    ...
                    <div class="panel-body email-panel-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <tbody>
                                @if($contacts->count())
                                @foreach($contacts->where('read_receipt', false) as $contact)
                                    <tr>
                                        <td><input type="checkbox"></td>
                                        <td><a href="javascript:void(0);" class="js-btn-email-star"><i class="fa fa-star"></i></a></td>
